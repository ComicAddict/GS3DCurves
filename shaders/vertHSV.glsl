...
void main() {
	fmode = mode;
	if(mode == 1){ // RGB to sRGB
		col = rgb2srgb(aColor);
	} else if(mode == 2){ // RGB to CV
		col = rgb2cv(aColor);
	} else if(mode == 3){ // RGB to HSV
		col = rgb2hsv(aColor);
	} else if(mode == 4){ // RGB to HSL
		col = rgb2HSL(aColor);
	} else if(mode == 5){ // RGB to CIEXYZ
		col = rgb2CIEXYZ(aColor);
	} else if(mode == 6){ // RGB to CIELAB
		col = rbg2CIELAB(aColor);
	} else if(mode == 7){ // RGB to CIELUV
		col = rgb2CIELUV(aColor);
	} else if(mode == 8){ // RGB to CIEHLC
		col = rgb2CIEHLC(aColor);
